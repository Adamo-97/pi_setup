...
======================
Combines footage + voiceover + subtitles into a final TikTok video.
...
def main(script_id: str, voiceover_id: str, footage_id: str) -> dict:
    ...
    game_title = ft_rows[0][1] or "tiktok"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Assemble TikTok video")
