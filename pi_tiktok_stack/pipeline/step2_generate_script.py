...
=======================
Uses the WriterAgent to generate a TikTok script from scraped news.
Picks top unused articles and generates an Arabic gaming script.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate TikTok script")
