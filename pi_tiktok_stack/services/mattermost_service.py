...
Mattermost Service
====================
Sends TikTok video previews and scripts to Mattermost for approval.
...
class MattermostService:
    ...
    def __init__(
        ...
        bot_token: str,
        channel_id: str,
        n8n_base_url: str = "http://localhost:5679",
    ):
    ...
    def send_approval_request(
        ...
        """
        Send a rich Mattermost message for video approval.
        ...
        message = (
            f"### :clapper: TikTok Video Ready — {content_type.replace('_', ' ').title()}\n\n"
            f"| Field | Value |\n"
            f"|:------|:------|\n"
    ...
    def send_status(self, message: str, level: str = "info") -> bool:
        ...
        return self._post_message(f"{emoji} **TikTok Pipeline:** {message}")
