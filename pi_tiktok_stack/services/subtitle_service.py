...
Subtitle Service
================
TikTok-viral word-by-word highlighted Arabic captions.
Generates subtitle overlay images/clips using Pillow for text rendering.
"""
...
logger = logging.getLogger("tiktok.subtitles")
...
class SubtitleService:
    """Generates TikTok-style word-by-word highlighted Arabic subtitles."""
...
"""
    ...
    def _calc_word_offset(words: List[SubtitleWord], word_index: int) -> int:
        ...
        # This is approximate; exact positioning requires font metrics
        avg_char_width = 20
        offset = 0
