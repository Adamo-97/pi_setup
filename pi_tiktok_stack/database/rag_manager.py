...
RAG Manager
===========
Vector search, deduplication, and feedback storage for the TikTok pipeline.
"""
...
logger = logging.getLogger("tiktok.rag")
...
class RAGManager:
    ...
    def search_similar(
        ...
        source_filter = "AND source_type = %s" if source_type else ""
        params: list = [vec_str, threshold, top_k]
        if source_type:
