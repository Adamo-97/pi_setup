-- ============================================================
-- pi_x_stack — PostgreSQL Schema (pgvector)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS video_footage (
    ...
    clip_type       VARCHAR(30)  DEFAULT 'gameplay',
    created_at      TIMESTAMPTZ  DEFAULT NOW()
);

-- -----------------------------------------------------------
-- 6. Rendered videos (final X/Twitter video output)
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS rendered_videos (
    ...
    status          VARCHAR(30)  DEFAULT 'rendered',
