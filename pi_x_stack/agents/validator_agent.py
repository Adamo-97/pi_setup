...
Validator Agent
===============
AI quality gate for X/Twitter video scripts.
Evaluates 7 X-specific criteria using Gemini and returns
...
logger = logging.getLogger("x.validator")
...
class ValidatorAgent(BaseAgent):
    ...
    def __init__(self):
        super().__init__(name="X Video Validator")
