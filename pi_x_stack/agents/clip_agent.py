...
for downloading relevant gameplay/trailer footage for X/Twitter videos.
"""
...
logger = logging.getLogger("x.clip_agent")

CLIP_SYSTEM_PROMPT = """أنت خبير في اختيار مقاطع الفيديو لـ X Gaming.
...
CLIP_SELECTION_PROMPT = """Analyze this X/Twitter video script and recommend video clips:
...
class ClipAgent(BaseAgent):
    """AI clip selection and footage planning for X/Twitter videos."""

    def __init__(self):
        super().__init__(name="X Video Clip Selector")
