...
Subtitle Service
================
X/Twitter video word-by-word highlighted Arabic captions.
...
logger = logging.getLogger("x.subtitles")
...
class SubtitleService:
    """Generates X/Twitter video word-by-word highlighted Arabic subtitles."""
