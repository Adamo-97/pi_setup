...
Step 1: Scrape News
===================
Scrapes trending gaming & controversial industry news from RSS, Google News, and Reddit.
Stores new articles in the database for X/Twitter script generation.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Scrape gaming & industry news for X/Twitter"
    )
    parser.add_argument(
        "--source",
