...
def main(script_id: str) -> dict:
    ...
    footage_result["game_title"] = primary_game
    footage_result["clip_type"] = clip_plan.get("clips", [{}])[0].get(
        "clip_type", "gameplay"
    )
    footage_id = downloader.store_footage(footage_result)
    ...
    logger.info(
        ...
        footage_id[:8] if footage_id else "?",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Download footage for X/Twitter video")
