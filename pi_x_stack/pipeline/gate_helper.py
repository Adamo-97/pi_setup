...
Usage (called by n8n Execute Command nodes):
  cd /home/node/tiktok_stack && python -m pipeline.gate_helper \
...
GATE_TITLES = {
    ...
    4: "جاهز للنشر — أرفق الفيديو والصورة المصغرة",
}


def main():
    parser = argparse.ArgumentParser(description="Send gate approval to Mattermost")
    parser.add_argument("--gate", type=int, required=True, help="Gate number (0-4)")
    ...
    parser.add_argument("--file-paths", type=str, nargs="*", default=[], help="File paths to attach")
