...
======================
Combines footage + voiceover + subtitles into a final X/Twitter video.
...
def main(script_id: str, voiceover_id: str, footage_id: str) -> dict:
    """
    Assemble final X/Twitter video.
    ...
    game_title = ft_rows[0][1] or "x_video"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Assemble X/Twitter video")
