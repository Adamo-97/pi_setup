...
class Metadata(BaseProcessor):
    ...
    def execute(
        ...
        try:
            ...
            logger.info("[%s] Metadata stored: id=%s", self.processor_name, metadata_id)
        except Exception as exc:
            logger.error("[%s] Failed to store metadata: %s", self.processor_name, exc)
