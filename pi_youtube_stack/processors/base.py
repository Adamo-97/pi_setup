...
Base Processor
===========
Abstract base class for all AI processors in the stack.
...
class BaseProcessor(ABC):
    ...
    Subclasses must implement:
        ...
        - processor_name (property): Human-readable agent name.
    """
    ...
    def get_previous_feedback(self, content_type: str) -> str:
        ...
        try:
            ...
            logger.warning("[%s] Feedback retrieval failed: %s", self.processor_name, exc)
    ...
    def check_duplicate(self, text: str) -> Optional[dict]:
        ...
        try:
            ...
            logger.warning("[%s] Duplicate check failed: %s", self.processor_name, exc)
            return None
    ...
    def store_in_rag(
        ...
        try:
            ...
            logger.error("[%s] Failed to store in RAG: %s", self.processor_name, exc)
