...
for downloading relevant gameplay/trailer footage for Instagram Reels.
"""
...
logger = logging.getLogger("instagram.clip_agent")

CLIP_SYSTEM_PROMPT = """أنت خبير في اختيار مقاطع الفيديو لـ Instagram Reels Gaming.
...
- Instagram aesthetic: prefer visually striking, high-quality footage

Output ONLY valid JSON."""

CLIP_SELECTION_PROMPT = """Analyze this Instagram Reel script and recommend video clips:
...
class ClipAgent(BaseAgent):
    """AI clip selection and footage planning for Instagram Reels."""

    def __init__(self):
        super().__init__(name="Instagram Reels Clip Selector")
