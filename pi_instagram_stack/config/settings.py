...
class DatabaseConfig:
    host: str = "localhost"
    port: int = 5435
    name: str = "instagram_rag"
    user: str = "ig_user"
    password: str = "ig_secure_pass_2025"
...
class NewsConfig:
    ...
    reddit_user_agent: str = "pi_instagram_stack/1.0"
    # Scraping limits
...
class _Settings:
    ...
    def _load(self):
        ...
        self.database = DatabaseConfig(
            ...
            port=int(e("DB_PORT", "5435")),
            name=e("DB_NAME", "instagram_rag"),
        ...
        self.redis = RedisConfig(
            url=e("REDIS_URL", "redis://localhost:6381"),
